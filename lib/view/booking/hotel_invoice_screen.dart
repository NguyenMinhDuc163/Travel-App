...
class _HotelInvoiceScreenState extends State<HotelInvoiceScreen> {
  ...
  Future<void> createInvoice(String email, UserViewModel userProvider, HotelBookingViewModel hotelBookingProvider) async {
              ...
              children: [
                ...
                ButtonWidget(
                  ...
                  ontap: () async {
                    ...
                    String? emailProfile = Provider.of<UserViewModel>(context, listen: false).user?.email.toString();
                    String? emailContact = Provider.of<HotelBookingViewModel>(context, listen: false).userContactModel?.email;
                    UserViewModel userProvider = Provider.of<UserViewModel>(context, listen: false);
                    HotelBookingViewModel hotelBookingProvider = Provider.of<HotelBookingViewModel>(context, listen: false);
